...
# вопрос 1
st.markdown("Какие строчки заставляют ваше сердце биться чаще?")
option_1 = st.radio(
    ...
    ('Они думали, мы упадём океанами стали, мне это нравится, нравится.', 'Я — это ты, ты — это я, и никого не надо нам.', 
     ...
     'Зачем мне солнце Монако, для чего скажи мне луна Сен Тропе?', 'Едем, едем в соседнее село на дискотеку! Едем, едем на дискотеку со своей фонотекой.'), label_visibility = "collapsed")
